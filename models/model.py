    ...
    def __init__(self, dim, depth, heads, dim_heads, mlp_dim, dropout = 0.):
        ...
        for _ in range(depth):
            self.layers.append(nn.ModuleList([
                PreNorm(dim, Attention(dim, heads = heads, dim_heads = dim_heads, dropout = dropout)),
...
class ViT(nn.Module):
    def __init__(self, *, image_size, patch_size, num_classes, dim, depth, heads, mlp_dim, pool = "cls", channel=3, dim_heads = 64, dropout=0., emb_dropout=0.):
        ...
        self.to_patch_embedding = nn.Sequential(
            ...
            nn.Linear(patch_dim, dim)  # batch_size channel height width -> batch_size num_patches patch_dim
